...
//    }
	...
	public Users(Integer user_id, LocalDate date, String email, String fullName, String gender, String moNumber,
			String password, String ref, String status, Set<Task> userTaskTasks, Set<UserRole> userRoles) {
		super();
		this.user_id = user_id;
		this.date = date;
		this.email = email;
